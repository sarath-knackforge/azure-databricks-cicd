...
def trigger_github_containerization(model_name: str, model_version: str):
    github_pat = dbutils.secrets.get(
        scope="github-secrets",
        key="github_pat"
    )

    url = "https://api.github.com/repos/sarath-knackforge/model-containerization/dispatches"
    ...
    logger.info("✅ GitHub containerization triggered")
...
# ---------------------------------------------------------
# TRIGGER GITHUB CONTAINERIZATION (UC-COMPATIBLE)
# ---------------------------------------------------------
trigger_github_containerization(
